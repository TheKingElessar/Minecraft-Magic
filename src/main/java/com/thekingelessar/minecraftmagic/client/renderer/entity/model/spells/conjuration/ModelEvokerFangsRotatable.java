package com.thekingelessar.minecraftmagic.client.renderer.entity.model.spells.conjuration;
...
@OnlyIn (Dist.CLIENT)
public class ModelEvokerFangsRotatable extends ModelBase
{
    ...
    public ModelEvokerFangsRotatable()
    {
